package transactionmanager.challange.infra.config;

import static java.lang.String.format;
import static transactionmanager.challange.infra.util.ScopeUtils.getScopeValue;
import static transactionmanager.challange.infra.util.ScopeUtils.isLocalScope;
...
public class SpringDocConfig {
  ...
  private static final String SERVER_URL = "https://%s-%s.example.com";
  /**
  ...
  public OpenAPI customOpenAPI(
    ...
    String url = isLocalScope() ? LOCAL_URL : format(SERVER_URL, getScopeValue(), appName);
